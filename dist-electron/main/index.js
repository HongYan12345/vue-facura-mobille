import require$$3, { app, Menu, session, BrowserWindow, ipcMain, shell } from "electron";
...
async function createWindow() {
  ...
  win.webContents.on("before-input-event", (event, input) => {
    const isOpenDevToolsShortcut = input.key === "F12" || input.control && input.shift && input.key.toLowerCase() === "i";
